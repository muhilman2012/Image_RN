...
class DetailsScreen extends React.Component {
  render() {
    return (
      <View style={styles.container}>
      	<Text style={styles.welcome}> Selamat Datang Pengguna Baru </Text>
        <Text>==============================</Text>
        <Text style={styles.welcome}>Nama : Muhamad Hilman</Text>
        <Text style={styles.welcome}>Kelas : XI RPL 1</Text>
        <Text style={styles.welcome}>Absen : 22</Text>
        <Text>==============================</Text>
        <Image source={require('./man.jpg')} style={styles.gambar}/>
      </View>
    );
  }
}
